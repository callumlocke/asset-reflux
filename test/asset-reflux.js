...
import AssetReflux from '..';

export default async function assetRefluxTest() {
  const ar = new AssetReflux({
    phases: [
  ...
  const outFiles3 = await ar.batch([
    {
      filename: 'one.css',
